...
model_age = 'mclr_age_sim.pkl'
model_females = 'mclr_females_sim.pkl'
model_males = 'mclr_males_sim.pkl'
model_hhtype = 'mclr_hhtype_sim.pkl'
model_familytype = 'mclr_familytype_sim.pkl'
model_malestofemales = 'mclr_malestofemales_1000_sim.pkl'
...
unique_ward_feature_set_npy = "np_unique_ward_feature_set_age_sim.npy"
...
def organize_training_data(ag_features_dict, ag_cat_list, ag_geoloc_list, ag_person_list, ag_ward_list):
   ...
   unique_ward_features = [0] * 44 # Contains the feature set for each ward. Must be size 44
   ...
   for i, cat in enumerate(ag_cat_list): 
      ...
      if(ward not in ward_list):
         index = ward - 1
         unique_ward_features[index] = dist_to_list(ag_features_dict[wardkey])
